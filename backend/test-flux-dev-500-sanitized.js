...
async function testFluxDev500Sanitized() {
    ...
    console.log("Testing NVIDIA with FLUX.1-dev to reproduce 500 error on sanitized prompt...");
    let prompt = `Create a eye-catching thumbnail, bold typography, vibrant colors, expressive facial reaction, dramatic lighting, high contrast, click-worthy composition, professional style for: "React in 10 days"Use a purple-dominant color palette, magenta and violet tones, modern and stylish mood color scheme.Additional details: a tutor with a laptop teaching react.The thumbnail should be 16:9, visually stunning, and designed to maximize click-through rate. Include large, highly readable, bold 3D typography prominently displaying the exact text: "React in 10 days". Make the text visually popping, professional, and impossible to ignore.`;
    prompt = prompt.replace(/expressive facial reaction|shocked|dramatic|violent|screaming|blood|pointing/gi, "calm and professional");
