    ...
    return (
        ...
        >
            <motion.div className="relative transform-3d w-full max-w-4xl" style={{ rotateX, rotateY }} >
                <motion.img src="/heroimg.png"
                    className=" broderb bg-linear-180 from-purple-500 to-transparent p-1 w-full rounded-[15px] will-change-transform transform-[translateZ(0)] py-1"
